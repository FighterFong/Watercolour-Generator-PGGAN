...
flags.DEFINE_integer("max_iters", 20, "Maxmization of training number") # 40000
...
flags.DEFINE_integer("step_by_save_sample", 1, "FLAG of gan training process") # 5000
flags.DEFINE_integer("step_by_save_weights", 20, "FLAG of gan training process") # 20000
